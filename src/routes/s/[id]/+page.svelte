...
<div class="flex flex-col items-center overflow-hidden">
	<div class="h-screen max-w-5xl w-full flex flex-col items-center p-24 space-y-20">
		...
		<section class="w-2/3 flex flex-col gap-y-2">
			...
			<img
				...
				alt="Arima Kana"
				class="object-contain w-full rounded-lg transition duration-1000 hover:-translate-x-full transform-gpu"
				draggable="false"
			/>
			<p class="text-sm self-end text-neutral-400">1/128</p>
		</section>
